...
class properties():
    def __init__(self, BBox, limb, frames=None, times=None, points=None):
        self.BBox = BBox
        self.limb = limb
        self.zone = None
        if not frames:
...
# define the measurements
    ...
    def save(self, filename):
        """
        Save the properties of the object to a FITS file.
        """
    ...
    def load(cls, filename):
        """
        Create an instance of the class from a FITS file.

        Parameters
        ----------

        filename: string
            The name of the FITS file to be loaded.

        Returns
        -------

        props : `properties`
            An instance of properties containg the data from the file.

        Examples
        --------

        >>> myprops = properties.load(filename)
        """
        # Load from file here and convert to lists.
        return cls(BBox, limb, frames=frames, times=times, points=points)
